    ...
    return (
        <section className="card w-72 h-72 bg-white rounded-lg shadow-md p-5 flex flex-col justify-between">
            ...
            <div className="w-full flex items-center justify-between">
                ...
                <Link to={html_url} className="botao w-10 h-10 rounded-lg bg-primary text-white text-xl flex items-center justify-center cursor-pointer hover:bg-red-500 transition-all duration-500">
                    <BsArrowRight />
                </Link>
            </div>
        </section>
